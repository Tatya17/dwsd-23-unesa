...
ALTER PROCEDURAL LANGUAGE plpgsql OWNER TO dbwarehouse;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.actor OWNER TO dbwarehouse;
...
ALTER TYPE public.mpaa_rating OWNER TO dbwarehouse;
...
ALTER DOMAIN public.year OWNER TO dbwarehouse;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO dbwarehouse;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO dbwarehouse;
...
ALTER TABLE public.category_category_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.category OWNER TO dbwarehouse;
...
ALTER TABLE public.film_film_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.film OWNER TO dbwarehouse;
...
ALTER TABLE public.film_actor OWNER TO dbwarehouse;
...
ALTER TABLE public.film_category OWNER TO dbwarehouse;
...
ALTER TABLE public.actor_info OWNER TO dbwarehouse;
...
ALTER TABLE public.address_address_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.address OWNER TO dbwarehouse;
...
ALTER TABLE public.city_city_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.city OWNER TO dbwarehouse;
...
ALTER TABLE public.country_country_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.country OWNER TO dbwarehouse;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.customer OWNER TO dbwarehouse;
...
ALTER TABLE public.customer_list OWNER TO dbwarehouse;
...
ALTER TABLE public.film_list OWNER TO dbwarehouse;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.inventory OWNER TO dbwarehouse;
...
ALTER TABLE public.language_language_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.language OWNER TO dbwarehouse;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.payment OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_01 OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_02 OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_03 OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_04 OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_05 OWNER TO dbwarehouse;
...
ALTER TABLE public.payment_p2007_06 OWNER TO dbwarehouse;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.rental OWNER TO dbwarehouse;
...
ALTER TABLE public.sales_by_film_category OWNER TO dbwarehouse;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.staff OWNER TO dbwarehouse;
...
ALTER TABLE public.store_store_id_seq OWNER TO dbwarehouse;
...
ALTER TABLE public.store OWNER TO dbwarehouse;
...
ALTER TABLE public.sales_by_store OWNER TO dbwarehouse;
...
ALTER TABLE public.staff_list OWNER TO dbwarehouse;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO dbwarehouse;
...
ALTER FUNCTION public.last_updated() OWNER TO dbwarehouse;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO dbwarehouse;
...
GRANT ALL ON SCHEMA public TO dbwarehouse;
